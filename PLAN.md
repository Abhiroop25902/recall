...
- [ ] **Verification**
    ...
    - Benchmark re-run (2026-09-14): against the direct Cloud Run endpoint, the corrected `saveMemory` request shape and `bash -n scripts/live-mcp-benchmark.sh` passed. The sequential client-observed run verified primary/control app isolation and deletion of all 36 temporary records: 30 saves mean 492 ms, p50 490 ms, p95 616 ms, p99 625 ms; 30 scoped top-one retrievals mean 503 ms, p50 481 ms, p95 683 ms, p99 875 ms.
